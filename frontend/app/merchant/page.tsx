...
import { TOKENS, QUIKPAY_CONTRACT_ADDRESS, PUSH_TESTNET } from "@/lib/contract"
...
export default function MerchantPage() {
  ...
  const publicClient = useMemo(() => {
    return createPublicClient({
      chain: PUSH_TESTNET as any,
      transport: http(PUSH_TESTNET.rpcUrls.default.http[0])
    })
  }, [])
  ...
  const generatePayment = async () => {
    ...
    try {
      ...
      const selectedChainId = chainId ?? PUSH_TESTNET.id
                      ...
                      <div className="space-y-6">
                        ...
                        <div className="bg-muted/50 rounded-lg p-4 space-y-2">
                          ...
                          <div className="flex justify-between">
                            ...
                            <span className="font-semibold">Push Chain Testnet</span>
                          </div>
                        </div>
                      </div>
                    ) : (
              ...
              <Card>
                <CardHeader>
                  ...
                  <div className="flex items-center gap-2 mt-2">
                    ...
                    <a className="text-xs text-muted-foreground" href={PUSH_TESTNET.blockExplorers.default.url} target="_blank" rel="noreferrer">Explorer</a>
                  </div>
                      ...
                      <div key={tx.id} className="border rounded-lg p-4 hover:bg-muted/50 transition-colors">
                        <div className="flex justify-between items-start mb-3">
                          ...
                          <div className="text-right">
                            ...
                            <a href={`${PUSH_TESTNET.blockExplorers.default.url}/tx/${tx.txHash}`} target="_blank" rel="noreferrer" className="text-xs text-blue-600 hover:underline">View Tx</a>
                          </div>
                        </div>
