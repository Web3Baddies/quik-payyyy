...
// Build Wagmi adapter with Push Chain Testnet network
const wagmiAdapter = new WagmiAdapter({
  networks: [
    {
      id: PUSH_TESTNET.id,
      name: PUSH_TESTNET.name,
      nativeCurrency: PUSH_TESTNET.nativeCurrency,
      rpcUrls: PUSH_TESTNET.rpcUrls,
      blockExplorers: PUSH_TESTNET.blockExplorers,
      testnet: true
    } as any
  ],
  projectId
